...
function Lava(pos, ch) {
  ...
  if (ch == "=") {
    ...
    // Cannon lava. Repeat back to this pos.
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    this.finishDelay = 1;
	deathCount++
	document.getElementById("lostTimes").innerHTML = "You have died <font color=\"red\">" + deathCount + "</font> times.";
    ...
    runLevel(new Level(plans[n]), Display, function(status) {
      if (status == "lost")
        ...
        startLevel(n + 1);
        	...
        	document.getElementById("lostTimes").innerHTML = "<h1> You have completed the game after only dying <font color=\"red\">" + deathCount + "</font> times. </h>";
    });
  }
  startLevel(0);
}
